...
#' are based off of Minitab®'s "Four in One" residual plots and
#' include the following:
#'
#' - A normal quantile plot
#' - A residual plot comparing predicted residuals to their
#'   actual value
#' - A residual plot comparing predicted residuals to the order
#'   in whihc they are observed
#' - A humble histogram
#'
#' @model A given fitted model object, such as, but not limited to,
#' those generated using lm() and aov().
#' @plotcolor An optional value for the color of points shown on
#' each plot.
#' @npplinecolor An optional value for the color of the line shown
#' in the normal quantile plot.
#' @yintcolor An optional value for the color of the y-intercept
